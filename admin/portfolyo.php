                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="" method="post" class="row" enctype="multipart/form-data">
                            <div class="col-12">
                                <input type="text" name="projeAdi" placeholder="Proje Adı" class="form-control">
                            </div>
                            ...
                            <div class="col-md-4 my-3">
                                ...
                                <input type="url" name="adres" placeholder="https://www.projeadresi.com" class="form-control">
                            </div>
                            <div class="col-md-4 my-3">
                            ...
                            <div class="col-12">
                                <button class="submit btn btn-success w-100" name="projeKaydet">Kaydet</button>
                            </div>
                        </form>
                    </div>
                </div>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"><?php echo $projeGuncelleSatir['projeAdi']; ?> - Güncelle</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="" method="post" class="row" enctype="multipart/form-data">
                    ...
                    <div class="col-12">
                        <button class="submit btn btn-success w-100" name="guncelle">Kaydet</button>
                    </div>
                </form>
            </div>
        </div>
